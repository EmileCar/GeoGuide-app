...
function svgMapWrapper(svgPanZoom) {
  class svgMap {
    ...
    init(options) {
      ...
      var defaultOptions = {
        ...
        flagURL: 'assets/img/flags/{0}.svg',
        ...
        // if the colordata of the countries shouldBeStatic
        colorDataStatic: true,
    ...
    createMap() {
      ...
      if (this.options.showContinentSelector) {
        ...
        this.continentSelect.addEventListener(
          ...
          function (e) {
            ...
            if (continent)
              this.zoomContinent(e.target.value);
          }.bind(that),
          { passive: true }
        );
      ...
      this.mapPanZoom = svgPanZoom(this.mapImage, {
        ...
        beforePan: function (oldPan, newPan) {
          ...
          var leftLimit = -((sizes.viewBox.x + sizes.viewBox.width) * sizes.realZoom) +
            gutterWidth;
  ...
  svgMap.prototype.mapPaths = {
    ...
    'BZ': {
      d: 'M482.5,471.1l1.4-2.2l1-0.2l1.3-1.7l1-3.2l-0.3-0.6l0.9-2.3l-0.4-1l1.3-2.7l0.3-1.8h-1.1l0.1-0.9h-1l-2.5,3.9 l-0.9-0.8l-0.7,0.3l-0.1,1l-0.7,5l-1.2,7.2L482.5,471.1L482.5,471.1z M1000.7,246.2l-4.4,1.3l-3.6-0.5l0,0l-3.8,1.2l0.7,2.2l2.2,0.1l2.4,2.4l3.4,2.9l2.5-0.4l4.4,2.8l0.4-3.5l1.3-0.2 l0.4-4.2l-2.8-1.4L1000.7,246.2L1000.7,246.2z'
    },
    'BJ': {
